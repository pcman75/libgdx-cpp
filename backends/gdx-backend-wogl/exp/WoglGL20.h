...
public:
	...
	virtual void glBindAttribLocation(int program, int index, const std::wstring& name);
	...
	virtual std::wstring glGetActiveAttrib(int program, int index, int* size, unsigned int* type);
	virtual std::wstring glGetActiveUniform(int program, int index, int* size, unsigned int* type);
	virtual void glGetAttachedShaders(int program, int maxcount, int* count, unsigned int* shaders);
	virtual int glGetAttribLocation(int program, const std::wstring& name);
	...
	virtual std::wstring glGetProgramInfoLog(int program);
	...
	virtual std::wstring glGetShaderInfoLog(int shader);
	virtual void glGetShaderPrecisionFormat(int shadertype, int precisiontype, int* range, int* precision);
	virtual std::wstring glGetShaderSource(int shader);
	...
	virtual int glGetUniformLocation(int program, const std::wstring& name);
	...
	virtual void glShaderSource(int shader, const std::wstring& string);
