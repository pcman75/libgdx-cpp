...
public:
	...
	virtual AudioDevice* newAudioDevice(int samplingRate, bool isMono);
	...
	virtual AudioRecorder* newAudioRecorder(int samplingRate, bool isMono);
	...
	virtual Sound* newSound(const FileHandle* fileHandle);
	...
	virtual Music* newMusic(const FileHandle* file);
};
