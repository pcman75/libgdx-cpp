...
public:
	...
	virtual std::string glGetActiveAttrib(int program, int index, int* size, unsigned int* type) = 0;
	virtual std::string glGetActiveUniform(int program, int index, int* size, unsigned int* type) = 0;
	...
	virtual std::string glGetShaderSource(int shader) = 0;
	...
	virtual void glShaderSource(int shader, const std::string& sources) = 0;
